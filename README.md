...
|----------|------------------------------------------------------------------|----------------------------------------|
|📲🪙🆓| [Sherlock](https://t.me/He_rlokbot?start=_ref_9pyalm_JJwlz5)| **Лучший бот с набором баз данных**, включая базы ВКонтакте. Множество уникальных данных и функций.|
|📲🪙| [Enigma](https://t.me/ynigmasscflbot?start=C96FP5YS)| Свежий бот общей разведки, который имеет на борту базы аккаунтов ВК и способен осуществлять по ним поиск.|
|📲🪙| [Himera](https://t.me/himer33fjierjfkoweijbot?start=406840159)| Бот работающий на законных основаниях (поэтмоу и дорогой), который способен находить профили ВКонтакте пользователей.|
...
В большинстве юрисдикций несанкционированный поиск информации VK (также [поиск в Фейсбук](https://github.com/OSINT-searcher/OSINT_i_probiv_Facebook), и других соцсетях) или сбор чужих персональных сведений запрещён и может нарушать законы о конфиденциальности и защите личных данных (например, статья 137 УК РФ, Закон «О персональных данных» и аналогичные акты других стран).
